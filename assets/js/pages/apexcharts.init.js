// var options={chart:
//   {height:380,type:"line",zoom:{enabled:!1},toolbar:{show:!1}},
...
//     tooltip:{y:[{title:{formatter:function(e){return e+" (mins)"}}},{title:{formatter:function(e){return e+" per session"}}},{title:{formatter:function(e){return e}}}]},
//     grid:{borderColor:"#f1f1f1"}};
//
//     (chart=new ApexCharts(document.querySelector("#line_chart_dashed"),options)).render();
//     options={chart:{height:350,type:"area"},
//     dataLabels:{enabled:!1},
...
//     options={chart:
//       {height:350,type:"bar",toolbar:{show:!1}},
...
//       dataLabels:{enabled:!0,formatter:function(e){return e+"%"},offsetY:-20,style:{fontSize:"12px",colors:["#304758"]}},
...
//             fill:{gradient:{shade:"light",type:"horizontal",
//                   shadeIntensity:.25,
