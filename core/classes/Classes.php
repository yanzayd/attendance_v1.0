...
class Classes
{
	...
	public function insert($fields = array()){
		if(!$this->_db->insert('attendance_class', $fields)){
	...
	public function update($fields = array(),$id = null){
		if(!$this->_db->update('attendance_class',$id,$fields)){
	 ...
	 */
	 public function delete($id = null){
 		if(!$this->_db->delete('attendance_class',array('id', '=', $id))){
 			throw new Exception('There was a problem updating');
 		}
 	}
	...
	public function find($id = null, $outputField=null, $limit = null){
		if($id){
			...
			if(is_numeric($id)){
				$field = 'id';
				$data = $this->_db->getAll('attendance_class', array($field, '=', $id),$limit);
				if($data->count()){
	 ...
	 */
	 public function select($sql = null, $params=array()){
 		$data = $this->_db->query("SELECT* FROM attendance_class {$sql}", $params);
 		if($data->count()){
