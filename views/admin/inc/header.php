...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>ATTENDANCE MIS</title>

	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="<?=DN?>/assets/vendors/images/apple-touch-icon.png">
	...
	<link rel="stylesheet" type="text/css" href="<?=DN?>/assets/src/plugins/datatables/css/dataTables.bootstrap4.min.css">
	<link rel="stylesheet" type="text/css" href="<?=DN?>/assets/src/plugins/datatables/css/responsive.bootstrap4.min.css">
...
<body>
	...
	<div class="header">
		...
		<div class="header-right">
            ...
            ?>
						<span class="user-name"><?=$session_user_data->firstname.' '.$session_user_data->surname?></span>
            <small>
              <?=$user_type->name?>
            </small>
					</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li class="dropdown">
						<a href="<?=DN?>/dashboard" class="dropdown-toggle">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="<?=DN?>/list/class">List Class</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
						...
						<ul class="submenu">
							...
							<li><a href="<?=DN?>/list/student">List Student</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
