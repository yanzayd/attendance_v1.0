                                  ...
                                  <div class="row">
                                      <div class="col-7">
                                          <div class=" p-3">
                                              ...
                                              <small>You can Update your Information here</small>
                                          </div>
                                      </div>
                                      <div class="col-5 align-self-end">
                                          <img src="assets/vendors/images/profile-img.png" alt="" class="img-fluid">
                                      </div>
                                  </div>
                              </div>
                                    ...
                                    <div class="tab-pane active" id="profile_info" role="tabpanel">
                                      ...
                                      <form method="post" id="simpleForm">
                                          <div class="form-group row mb-2">
                                              <div class="col-sm-12">
                                                <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Nom" value="<?= $session_user_data->firstname ?>">
                                              </div>
                                          </div>
                                          <div class="form-group row mb-2">
                                              <div class="col-sm-12">
                                                <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Postnom" value="<?= $session_user_data->lastname ?>">
                                              </div>
                                          </div>
                                          <div class="form-group row mb-2">
                                              <div class="col-sm-12">
                                                <input type="text" class="form-control" id="surname" name="surname" placeholder="Prenom" value="<?= $session_user_data->surname ?>">
                                              </div>
                                          </div>
                                          <div class="form-group row mb-2">
                                              <div class="col-sm-12">
                                          ...
                                          <div class="form-group row mb-2">
                                              <div class="col-sm-12">
                                                <input type="text" class="form-control" id="telephone" name="telephone" placeholder="+243999999999" value="<?= $session_user_data->telephone ?>">
                                              </div>
                                          </div>
                                          <div class="form-group row mb-2">
                                              <div class="col-sm-12">
                                                <input type="text" class="form-control" id="address" name="address" placeholder="Adresse" value="<?= $session_user_data->address ?>">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group row justify-content-end">
                                              <div class="col-sm-12">
                                                  <div>
                                                      <button type="button" class="btn btn-primary w-md SubmitUpdateInformation" style="background: #2A3F54;">Mettre a jour</button>
                                                  </div>
                                              </div>
                                          </div>
                                      </form>
                                      ...
                                      <br>
                                        <div>
                                          <form method="post" id="simpleForm">
                                              <div class="form-group row mb-2">
                                                  <div class="col-sm-12">
                                                    <input type="password" class="form-control" id="cpassword" name="cpassword" placeholder="Ancien Mot de Passe">
                                                  </div>
                                              </div>
                                              <div class="form-group row mb-2">
                                                  <div class="col-sm-12">
                                              ...
                                              <div class="form-group row mb-2">
                                                  <div class="col-sm-12">
                                                    <input type="password" class="form-control" id="repassword" name="repassword" placeholder="Retyper encore le mot de Passe">
                                                  </div>
                                              </div>
                                              <input type="hidden" name="request" value="user-new">
                                              <input type="hidden" name="webToken" value="256">
                                              <div class="form-group row justify-content-end">
                                                  <div class="col-sm-12">
                                                      <div>
                                                          <button type="button" class="btn btn-primary w-md SubmitUpdatePassword" style="background: #2A3F54;">Changer Mot de Passe</button>
                                                      </div>
                                                  </div>
                                              </div>
                                          </form>
