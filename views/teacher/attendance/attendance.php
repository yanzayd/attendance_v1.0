        ...
        <div class="card-box mb-30">
          <div class="pd-20">
            <h4 class="text-blue h4">General Attendance</h4>
				...
				<button disabled class="btn btn-primary btn-sm col-lg-3" style="background: #2A3F54; " data-toggle="modal" data-target="#addAttendance"><i class="fa  fa-plus"> </i>  New Attendance</button><br>
				<!-- MODAL -->
