				...
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30" id="card-<?= Hash::encryptToken($student_->id)?>">
					<div class="pd-20 card-box height-100-p">
						...
						<div class="text-center">
							<button disabled type="button" style="Background: #2A3F54" class="btn btn-success dw dw-eye SubmitEdit" onclick="window.location.href='<?=DN?>/profile/student/<?= Hash::encryptToken($student_->id) ?>';" title="View"></button>
							<button disabled type="button" style="Background: #218838" class="btn btn-success dw dw-edit2 SubmitEdit" onclick="window.location.href='<?=DN?>/edit/student/<?= Hash::encryptToken($student_->id) ?>';" title="Edit"></button>
							<button disabled type="button" style="Background: #dc3545" class="btn btn-success dw dw-delete-3 SubmitDelete" data-arg="<?= Hash::encryptToken($student_->id) ?>" title="Delete"></button>
						</div>
					</div>
				</div>
<?php
